...
export const CATEGORY_COLORS: Record<string, { bg: string; text: string; label: string }> = {
  ...
  customer_inquiry: { bg: 'bg-blue-100 dark:bg-blue-900/30', text: 'text-blue-700 dark:text-blue-400', label: 'Inquiry' },
  inquiry: { bg: 'bg-blue-100 dark:bg-blue-900/30', text: 'text-blue-700 dark:text-blue-400', label: 'Inquiry' },
